...
# 🏄 Surf - XAI Grok Computer Use Agent + E2B Desktop

A Next.js application that allows AI to interact with a virtual desktop environment. This project integrates [E2B's desktop sandbox](https://github.com/e2b-dev/desktop) with XAI's Grok API to create an AI agent that can perform tasks on a virtual computer through natural language instructions.
...
3. [**XAI Grok Computer Use**](https://x.ai/): Processes user instructions and generates actions for the AI agent
...
4. Backend processes the instructions using XAI's Grok API
...
- **AI-Powered Interaction**: Uses XAI's Grok API to understand and execute user instructions
...
- **XAI**: SDK for interacting with XAI's Grok API
...
- **AI not responding**: Check that your XAI API key is valid and has access to the required models
